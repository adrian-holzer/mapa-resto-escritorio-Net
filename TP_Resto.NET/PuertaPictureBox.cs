...
{
    class PuertaPictureBox : PictureBox
    {
        bool down = false;
        Point inicio;
        ...
        public PuertaPictureBox(bool moverse)
        {
            this.Paint += PuertaPictureBox_Paint;
            if (moverse)
            {
        ...
        private void PuertaPictureBox_Paint(object sender, PaintEventArgs e)
        {
